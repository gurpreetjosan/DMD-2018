...
##----------------------Testing Multiclass DMD--------------- #####

inFileName = "multiclass-dmd-2L-model"
#load label encoder
...
foldername = 'test/Task-2/testing/Testing 1/test1.txt'  # Replace with testing file path
domains = load_test_data(foldername)
rsltfile = open("TeamJosan_Task2-testing1-test1-SubmissionNo-2.csv", 'w') #replace with your own file name
print("writing file ")
count = 0
